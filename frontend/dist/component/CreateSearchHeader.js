...
function CreateSearchHeader() {
    ...
    function autocomplete() {
        ...
        containerValue === null || containerValue === void 0 ? void 0 : containerValue.classList.add('header__cont-value');
        containerValue === null || containerValue === void 0 ? void 0 : containerValue.classList.remove('header__cont-value-active');
        let arr = [];
        input.addEventListener('keydown', () => __awaiter(this, void 0, void 0, function* () {
            const itemData = yield fetch('http://localhost:3000/api/clients');
            const itemDataList = yield itemData.json();
            ...
            function ff(name) {
                for (let i = 0; i < itemDataList.length; i++) {
                    ...
                    arr.length = 0;
                    if (name > -1) {
                        containerValue === null || containerValue === void 0 ? void 0 : containerValue.classList.add('header__cont-value-active');
