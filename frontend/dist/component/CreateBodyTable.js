...
function CreateBodyTable(validateItem) {
    ...
    function PopupLink(type, value, icon) {
    ...
    moveDelete.addEventListener('click', (e) => {
        e.preventDefault();
    ...
    moveChange.addEventListener('click', (e) => {
        e.preventDefault();
        let html = document.documentElement;
        let scrollPosition = trackClick[trackClick.length - 1];
        html.style.top = -scrollPosition + "px";
    ...
    moveChange.addEventListener('click', (e) => __awaiter(this, void 0, void 0, function* () {
        const response = yield fetch(`http://localhost:3000/api/clients/${id.innerHTML}`);
        ...
        containerMain === null || containerMain === void 0 ? void 0 : containerMain.append(changeModalWindow.externalContModal);
    }));
    ...
    changeModalWindow.btnDeleteForm.addEventListener('click', (e) => {
        e.preventDefault();
        containerMain === null || containerMain === void 0 ? void 0 : containerMain.append(deleteItemTable.externalContModal);
    });
    ...
    changeModalWindow.btnDoneForm.addEventListener('click', (e) => __awaiter(this, void 0, void 0, function* () {
        e.preventDefault();
        const dataItemType = [];
        const dataItemValue = [];
        let typeArr;
